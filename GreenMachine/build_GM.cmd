...
:: Copy the Green Machine BLHeli software but leave out the file terminator
...
:: Add the BLHeli bootloader and include the file terminator
set "cmd=findstr /R /N "^^" %Bootloader% | find /C ":""
for /f %%a in ('!cmd!') do set lineCount=%%a

SET startLine=3
SET currentLine=1
SET maxLine=%lineCount%
